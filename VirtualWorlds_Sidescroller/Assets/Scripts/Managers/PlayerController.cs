...
public class PlayerController : MonoBehaviour
{
    ...
    IEnumerator JumpCooldown()
    {
        ...
        AudioManager.Instance.PlaySFX(AudioManager.SFX.player_jump);
    ...
    public void PlayFootstep()
    {
        if (isCrouching)
        {
            AudioManager.Instance.PlayFootstep(AudioManager.FootstepType.Sneaking);
        }
        else
        {
            AudioManager.Instance.PlayFootstep(AudioManager.FootstepType.Normal);
        }
    }
}
